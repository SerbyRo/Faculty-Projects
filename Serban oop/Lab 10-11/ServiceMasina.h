...
private:
	...
	vector<unique_ptr<ActiuneUndo>> undo_action;
...
public:
	...
	*/
	const vector<Masina>& getworklist() noexcept;
	/*
	...
	*/
	void undo();
	/*
	* functie care cauta o masina dupa numar de inmatriculare
	*/
	Masina findservice(string nrinmatriculare);
};
