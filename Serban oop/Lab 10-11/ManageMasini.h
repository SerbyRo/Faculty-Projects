...
class ManageMasini:public Observable
{
private:
...
public:
	...
	*/
	...
	ManageMasini(const ManageMasini& mas) = delete;
	void operator=(const ManageMasini& mas) = delete;
	/*
	...
	*/
	const vector<Masina>& getallmasini() const noexcept {
		return masini;
	}
	/*
