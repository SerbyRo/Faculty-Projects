...
void testQuantity() {//scopul e sa adaugam multe date 
	Colectie c;
	for (int i = 10; i >= 1; i--) {
		cout << "Am adaugat in colectie!" << endl;
	...
	//cout << "Am adaugat in colectie!" << endl;
	//assert(c.dim() == 175739);
	//cout << "Am verificat dimensiunea!" << endl;
	...
	//	ic.urmator();
	//}
	//cout << "Am verificat iteratorul!" << endl;
	//ic.prim();
	...
	//	ic.urmator();
	//}
	//cout << "Am verificat iteratorul 2!" << endl;
	//assert(ic.valid() == false);
	for (int i = 0; i < 10; i++) { //stergem multe elemente existente si inexistente
		cout << "Am sters elementul!" << endl;
		for (int j = 40000; j >= -40000; j--) {
			c.sterge(j);
		}
	}
	cout << "Asteptam sa termine programul!" << endl;
	//assert(c.dim() == 0);
	cout << "Zeu" << endl;
}
